...
year. In that case, we could have another column for for day. In
other words, there are different levels of ``longness''. The ultimate shape you
want to get your data into will depend on what you are doing with it.
...
One ``mistake'' you might find yourself making is casting a data set in which there is more than one value per data cell. For example:
